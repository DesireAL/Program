...
time = 0.1 ; time3 = 1.5    # time为字间隔,time3为句间隔  ###################0.1   1.5
        ...
        while True:
            ...
            if text != None and x == 1:
                ...
                if (string[0] == "'" or string[0] == '"') and (string[0] == string[-1]):
                    ...
                    p.Ex(59, 60, time, time3)   # 引号错误，请重试
                    continue
                else:
                    p.Ex(61, 62, time, time3)   # 字符串有误，请重试
                    continue
...
#            p.Pl(0, 11, event, screen, time, time3)
            ...
            start_game.play()
        elif text != None and text in ('ex1','ex2','ex3','ex4','ex5'):   # 调试用 可跳关 输入其他东西会报错
